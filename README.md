...
(라즈베리파이 작동 환경에서 문제가 생겨 연결 문제를 해결한 뒤 활동 과정과 활동 사진을 재업로드 예정)

### 기계 제조

구체적인 구상도 제작과 그에 관한 부품 조사와, 각 부품에 따른 기능 구상

![KakaoTalk_20201005_013147365_01](https://user-images.githubusercontent.com/70554317/95021237-bcff7f80-06aa-11eb-8320-2e4af7897c96.jpg)

아두이노 워터 펌프를 이용해 음료가 담긴 병에서 기압차와 모터를 이용해 음료를 배출해내는 방법 구상.

![KakaoTalk_20201005_013147365_02](https://user-images.githubusercontent.com/70554317/95021271-f9cb7680-06aa-11eb-8d5a-44f254b6435e.jpg)

아두이노 서보 모터를 이용해 호스제어를 주로 음료 배출을 제어하는 방법 구상.

아두이노 서보 모터 혹은 아두이노 워터 펌프를 이용해 음료 배출 제어 예정. 제품 구매 시 서보 모터와 워터 펌프 두가지를 다 구매해 각각 제작후 가동해본뒤, 기계 작동에 지장이 없는쪽으로 부품을 선택해 제작 예정.
